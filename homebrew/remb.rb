...
# Tap: brew tap richie/remb
# Install: brew install remb
#
# To publish this tap:
#   1. Create a repo: github.com/richie/homebrew-remb
...
class Remb < Formula
  ...
  homepage "https://remb.vercel.app"
  version "0.1.0"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/richie/remb/releases/download/v#{version}/remb-darwin-arm64"
      sha256 "REPLACE_WITH_SHA256_OF_remb-darwin-arm64"
    end
    on_intel do
      url "https://github.com/richie/remb/releases/download/v#{version}/remb-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/richie/remb/releases/download/v#{version}/remb-linux-arm64"
      sha256 "REPLACE_WITH_SHA256_OF_remb-linux-arm64"
    end
    on_intel do
      url "https://github.com/richie/remb/releases/download/v#{version}/remb-linux-amd64"
